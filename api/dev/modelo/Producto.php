...
require_once dirname ( __FILE__ ) . "/../../../dev/recursos/FDPDF/MultiCellBlt2.php";
...
";
	...
	function construirPDFMedica($certificado, $nombre, $vigencia) {
		...
		$pdf = new PDF('P','mm');
		$pdf->AddPage();
		$pdf->Image(dirname ( __FILE__ ) . "/../../../dev/recursos/imagenes/logo_mail.png",50,10,110,0,'PNG');
		...
		$pdf->Ln();
		$pdf->Image(dirname ( __FILE__ ) . "/../../../dev/recursos/imagenes/tarjeta_corte.png",50,$pdf->getPageHeight() - 60 ,110,0,'PNG');
